...
<body>
 ...
 if("valid".equals(msg)){
	 %>
	 <center><font color="red" size="5">Form submitted successfully. You will get notified with 24 hours.</font></center>
<% 
 ...
 if("invalid".equals(msg)){
	 %>
	 <center><font color="red" size="5">Invalid Request.Try again</font></center>
<% 
...
<h3><center>All Right Reserved with Firoze  </center></h3>
